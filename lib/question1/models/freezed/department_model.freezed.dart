...
class _$DepartmentImpl implements _Department {
  ...
  @override
  String toString() {
    return 'Department(deptId: $deptId, name: $name, manager: $manager, meetingTime: $meetingTime, budget: $budget, year: $year, availability: $availability)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, deptId, name, manager,
      meetingTime, budget, year, availability);
...
abstract class _Department implements Department {
  const factory _Department(
      ...
      required final Availability? availability}) = _$DepartmentImpl;
